...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth:api')->group(function (): void {
        ...
        Route::post('stock-counts/{stockCount}/start', [StockCountController::class, 'start'])->middleware('permission:stock_counts.create');
        Route::post('stock-counts/{stockCount}/complete', [StockCountController::class, 'complete'])->middleware('permission:stock_counts.create');
